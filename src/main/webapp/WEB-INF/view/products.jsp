...
<div class="jumbotron">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a style="color:#989a9c" href="${pageContext.request.contextPath}/toBasket"><span
                class="glyphicon glyphicon-shopping-cart"></span> Koszyk</a></li>
        <li><a style="color:#989a9c" href="${pageContext.request.contextPath}/login"><span
            ...
            <div class="container">
                ...
                <c:forEach items="${products}" var="product">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <h1>
                                <a style="color:#989a9c"
                                   href="<c:url value="${pageContext.request.contextPath}/produkt?id=${product.id}"/>">${product.brand} ${product.model}</a>
                            </h1>
                        ...
                        <div class="col-sm-3">
                            ...
                            <form action="${pageContext.request.contextPath}/addToBasket?id=${product.id}"
                                  method="post">
